...
class SyliusMailerConfig implements \Symfony\Component\Config\Builder\ConfigBuilderInterface
{
     ...
     * @return $this
     */
    public function senderAdapter($value): static
    {
     ...
     * @return $this
     */
    public function rendererAdapter($value): static
    {
    ...
    /**
     * @default {"name":"Example.com Store","address":"no-reply@example.com"}
    */
     ...
     * @return $this
     */
    public function templates(string $name, mixed $value): static
    {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('emails', $value)) {
            $this->_usedProperties['emails'] = true;
            $this->emails = array_map(fn ($v) => new \Symfony\Config\SyliusMailer\EmailsConfig($v), $value['emails']);
            unset($value['emails']);
        }
    ...
    public function toArray(): array
    {
        ...
        if (isset($this->_usedProperties['emails'])) {
            $output['emails'] = array_map(fn ($v) => $v->toArray(), $this->emails);
        }

...
class getSylius_Form_Type_AdminUserService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['sylius.form.type.admin_user'] = new \Sylius\Bundle\CoreBundle\Form\Type\User\AdminUserType('App\\Entity\\User\\AdminUser', $container->parameters['sylius.form.type.admin_user.validation_groups'], 'fr_FR');
    }
}
